...
class NumberedCanvas(canvas.Canvas):
    ...
    def _draw_decorations(self, total_pages: int):
        ...
        if page_num == 1:
            # Cover page: suppress all headers, footers, rules, and branding
            self.restoreState()
            return
...
def export_pdf(result: dict, filename: str = "") -> bytes:
    ...
    story.append(Paragraph(
        ...
        ParagraphStyle("CoverTitle", fontName="Helvetica-Bold", fontSize=28,
                       leading=36, textColor=C_CRIMSON_DARK, spaceAfter=15, alignment=1)
    ))
    ...
    story.append(Paragraph(
        ...
        ParagraphStyle("CoverDate", fontName="Helvetica", fontSize=11,
                       leading=16, textColor=C_MUTED, alignment=1)
    ))
